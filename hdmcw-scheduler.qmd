...
Apple calls a _quantum_ is also dependent on the clutch/QoS.  It looks like the scheduler starts with what's called
a worst case execution latency (WCEL)
...
I think this mean all of the threads launched from a particular process.  This level is said to use a variant
