...
Mac OS (since El Capitan) called System Integrity Protection, or SIP.  It's very useful for protecting
your Mac from malicious hackers because it limits what can be done even by the most
...
where i've dropped a bunch of initial system calls.  You can see that it eventually calls the _read()__ system call in the XNU kernel.
