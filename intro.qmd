...
the mid 80s.  Borland came out with Turbo Pascal in 1983, but you couldn't get a cheap C
compiler.  You could buy magazines on the newstand that would show you cool assembly language
...
decided to stay at a slightly higher level because
 ...
 1. I don't know much about those things, and
 1. Once you start down that rabbit hole you can't stop until you start talking about quantum mechanics.

If you want
to check out some books on computer architecture, i'd recommend [Essentials of Computer Architecture](https://www.routledge.com/Essentials-of-Computer-Architecture/Comer/p/book/9781032727196) by Douglas Comer [@comer2017essentials], and [Code](https://codehiddenlanguage.com/) by Charles Petzold [@petzold2000code].  Also checkout CPU Land[@cpuland], which covers a lot of the same ground that I do, but better and for Linux.  I don't have any recommendations for learning quantum mechanics.
